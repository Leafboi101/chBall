...
public class Canvas
{
    ...
    public void setForegroundColor(int alpha, String colorString)
    {
        if(colorString.equals("red"))
            graphic.setColor(new Color(218, 41, 18, alpha));
            ...
            graphic.setColor(new Color(95, 193, 0, alpha));
        else if(colorString.equals("dark green"))
            graphic.setColor(new Color(85, 174, 0, alpha));
            ...
            graphic.setColor(new Color(202, 201, 198, alpha));
        else if(colorString.equals("cyan"))
            graphic.setColor(new Color(135, 206, 235, alpha));
        else if(colorString.equals("lake"))
            graphic.setColor(new Color(75, 100, 239, alpha));
        else if(colorString.equals("dark lake"))
            graphic.setColor(new Color(53, 70, 167, alpha));
        else
            graphic.setColor(Color.black);
    }
